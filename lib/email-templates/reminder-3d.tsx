...
export function getReminderEmail3d({ firstName, progressPct, resumeLink, unsubscribeLink }: ReminderEmailParams) {
...
<body style="margin:0;padding:0;background:#f6f8fb;color:#1f2937;font-family:Arial,Helvetica,sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    <tr><td align="center" style="padding:28px 14px;">
      <table class="card" role="presentation" width="100%" style="max-width:560px;background:#ffffff;border-radius:16px;padding:28px;">
        ...
        <tr><td style="font-size:20px;font-weight:700;padding:6px 0;">Final reminder: complete your plan today</td></tr>
        ...
        <tr><td style="font-size:15px;line-height:22px;padding:6px 0;color:#dc2626;font-weight:600;">
          We'll keep your answers for 7 more days before they're deleted.
        </td></tr>
  ...
  return {
    subject: "Final reminder: complete your plan today",
    html,
  }
}
