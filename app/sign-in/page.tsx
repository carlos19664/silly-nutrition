        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to your Silly Nutrition account</p>
            </div>
            ...
            <div className="mt-8 pt-6 border-t">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button type="button" variant="outline" className="bg-transparent" onClick={handleGoogleSignIn}>
                ...
                <Button type="button" variant="outline" className="bg-transparent" onClick={handleGitHubSignIn}>
