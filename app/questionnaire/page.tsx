...
const questionnaireSchema = z.object({
  ...
  // Plan Selection
  planType: z.enum(["single-meal", "single-workout", "single-complete", "essential", "coaching"]),
})
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-[#1E4E78]">Single Plans</CardTitle>
                ...
                <CardContent>
                  <RadioGroup
                    ...
                    onValueChange={(value) => {
                      console.log("[v0] RadioGroup onValueChange:", value)
                      form.setValue("planType", value as any)
                    }}
                  >
                    <div className="space-y-3">
                      <div
                        className={`flex justify-between items-center p-3 rounded-lg border-2 cursor-pointer transition-all ${
                          form.watch("planType") === "single-meal"
                            ? "border-[#F4B728] bg-[#F4B728]/10"
                            : "border-gray-200 hover:border-[#F4B728]/50"
                        }`}
                        onClick={() => {
                          console.log("[v0] Clicked single-meal")
                          form.setValue("planType", "single-meal")
                        }}
                      >
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem value="single-meal" id="single-meal" />
                          <Label htmlFor="single-meal" className="cursor-pointer">
                            Meal Plan Only
                          </Label>
                        </div>
                      ...
                      <div
                        className={`flex justify-between items-center p-3 rounded-lg border-2 cursor-pointer transition-all ${
                          form.watch("planType") === "single-workout"
                            ? "border-[#F4B728] bg-[#F4B728]/10"
                            : "border-gray-200 hover:border-[#F4B728]/50"
                        }`}
                        onClick={() => {
                          console.log("[v0] Clicked single-workout")
                          form.setValue("planType", "single-workout")
                        }}
                      >
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem value="single-workout" id="single-workout" />
                          <Label htmlFor="single-workout" className="cursor-pointer">
                            Workout Plan Only
                          </Label>
                        </div>
                      ...
                      <div
                        className={`flex justify-between items-center p-3 rounded-lg border-2 cursor-pointer transition-all ${
                          form.watch("planType") === "single-complete"
                            ? "border-[#F4B728] bg-[#F4B728]/10"
                            : "border-gray-200 hover:border-[#F4B728]/50"
                        }`}
                        onClick={() => {
                          console.log("[v0] Clicked single-complete")
                          form.setValue("planType", "single-complete")
                        }}
                      >
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem value="single-complete" id="single-complete" />
                          <Label htmlFor="single-complete" className="cursor-pointer">
                            Complete Package
                          </Label>
                        </div>
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <div className="text-sm text-gray-500 line-through">£89/month</div>
                      <div className="text-2xl font-bold text-[#F4B728]">£69/month</div>
                    </div>
                  </div>
                </CardHeader>
              </Card>
              ...
              >
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <div className="text-sm text-gray-500 line-through">£199/month</div>
                      <div className="text-2xl font-bold text-[#F4B728]">£149/month</div>
                    </div>
                  </div>
                </CardHeader>
              </Card>
