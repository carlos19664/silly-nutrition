...
export function getReminderEmail1h({ firstName, progressPct, resumeLink, unsubscribeLink }: ReminderEmailParams) {
  const html = `<!doctype html>
<html>
<head>
  <meta charset="utf-8">
  <title>Your plan is waiting</title>
...
<body style="margin:0;padding:0;background:#f6f8fb;color:#1f2937;font-family:Arial,Helvetica,sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    <tr><td align="center" style="padding:28px 14px;">
      <table class="card" role="presentation" width="100%" style="max-width:560px;background:#ffffff;border-radius:16px;padding:28px;">
        ...
        <tr><td style="font-size:20px;font-weight:700;padding:6px 0;">Pick up where you left off</td></tr>
  ...
  return {
    subject: "Your personalised plan is waiting — pick up where you left off",
    html,
  }
}
