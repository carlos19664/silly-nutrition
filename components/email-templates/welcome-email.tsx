...
export function WelcomeEmail({ firstName, planType }: WelcomeEmailProps) {
  ...
  return (
    <EmailLayout preheader="Welcome to Silly Nutrition! Let's get started on your health journey.">
      ...
      <div className="highlight-box">
        <div
          style={{
            ...
            backgroundColor: isCoaching ? "#1E4E78" : "#F4B728",
            color: isCoaching ? "#F4B728" : "#1E4E78",
            padding: "6px 12px",
            borderRadius: "20px",
            fontSize: "12px",
            fontWeight: "600",
        ...
        >
          {isCoaching ? "Coaching Plan - Most Popular" : "Essential Plan"}
        </div>
      ...
      <p>
        Here's to a healthier, simpler you 💪<br />
